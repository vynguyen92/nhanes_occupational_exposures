run_stepwise_regressions <- function(dataset_merged
                                     , vector_equtions
                                     , df_stats
                                     ...
                                     , type_of_weighted_model = NULL)
{
  ...
  # vector_chemical_codenames <- "LBXACR"
  # vector_chemical_codenames <- "LBXCOT"
  ...
  for(i in seq(num_equations))
  {
    ...
    for(j in seq(num_include_occupation_missing))
    {
      ...
      df_regressions_j <- dataset_long %>%
        ...
        do(run_individual_chem_regression(.
                                          , excluded_type_j
